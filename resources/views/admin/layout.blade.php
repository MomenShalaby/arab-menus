...
<head>
    ...
    <title>@yield('title', 'لوحة التحكم') - ناكل ايه</title>
        ...
        <aside class="w-64 bg-gray-900 text-white flex-shrink-0 fixed h-full z-40">
            <div class="p-4 border-b border-gray-700">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="font-bold text-sm">ناكل ايه</h1>
            ...
            <nav class="p-4 space-y-1">
                ...
                <a href="{{ route('admin.settings.index') }}"
                    class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm text-gray-300 hover:bg-gray-800 hover:text-white transition-colors {{ request()->routeIs('admin.settings.*') ? 'active' : '' }}">
